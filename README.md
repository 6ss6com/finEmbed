...
| 项目 | 状态 | 说明 |
|------|------|------|
| finEmbed_v1.pkl | ✅ 已完成 | R^2=0.54，188条训练数据 |
| 评估准确率 | 5/5对 | 全部通过 |

## 训练结果

- 模型: `models/finEmbed_v1.pkl` (1.2 KB)
- R^2: 0.5403 (5 epochs)
- 测试用例: 茅台<->贵州茅台, 招商银行<->银行股, 中国神华<->高股息, 光伏<->新能源, AI大模型<->人工智能

## 下一步

- [ ] 用真实Sentence-Transformers微调（需要网络下载模型）
- [ ] 增加更多金融领域训练数据
- [ ] 发布到HuggingFace
